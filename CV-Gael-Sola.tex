...
\item Support the development of improved \textbf{forest monitoring} in Viet Nam:
	...
	\item Organize \textbf{participatory workshops} on monitoring systems for local forest activity in six provinces,
	\end{itemize}
...
Vietnamese & \faStar \faStarO \faStarO \faStarO \faStarO & \\
...
\cvitem{Statistics/data science}{R, SAS, SQL, Python, Linux}
\cvitem{Office suites}{MS Office, OpenOffice, \LaTeX}
\cvitem{Geographic Information systemsn}{QGIS, ArcGIS, Erdas, R}
...
\cvlistdoubleitem{Cooking}{Travels}
