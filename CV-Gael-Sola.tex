...
%% Use natbib for citations and renewcommand to remove title for reference section
%\usepackage{natbib} 
%\usepackage[resetlabels,labeled]{multibib} %% to have 2 separate bib for authoring and contributor
%\newcites{Contrib}{Contributions}
%\renewcommand{\bibsection}{}
%\bibliographystyle{fbs} %% Need to have the file in the main dir
%\bibliographystyleContrib{fbs} 
\usepackage[backend=bibtex, style=authoryear, sorting=ynt, maxbibnames=99]{biblatex}
...
\nocite{Sola12} %% Need to run one time to genreate the bibliography
\nocite{*}
